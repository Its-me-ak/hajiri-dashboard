...
const BudgetAllocation = () => {
    ...
    return (
        <div className="border border-gray-200 mt-3 py-2">
            <h1 className="mb-2 px-3 text-slate-700 font-semibold text-lg">Departmental Budget Allocation</h1>
           <div className="flex justify-between gap-2 border-t border-gray-200 pt-3 px-3">
                {
                    budgets.map((budget) => (
                        <div key={budget.amount} className=" border-r border-gray-200 mb-2 pe-3">
